...
public class DetalleFragment extends Fragment {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        pelicula = new Peliculas(unBundle.getString("nombre"),unBundle.getInt("imagen"),unBundle.getInt("imagenPortada"),unBundle.getString("genero"),unBundle.getString("desc"),unBundle.getInt("puntuacion"),unBundle.getString("aptoTodoPublico"));
    ...
    public void mostrarInformacion(){
        ...
        //puntuacion.setText(pelicula.getPuntuacion());
